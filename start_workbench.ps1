...
Write-Host "      🚀 STARTING SOVEREIGN AI WORKBENCH (WINDOWS POWERSHELL)" -ForegroundColor Cyan
Write-Host "======================================================================" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "⚠️ Not running. Launching 'ollama serve'..." -ForegroundColor Yellow
...
try {
    ...
    Write-Host "⚠️ Not running. Launching FastAPI backend..." -ForegroundColor Yellow
...
try {
    ...
    Write-Host "⚠️ Not running. Launching React frontend..." -ForegroundColor Yellow
    Start-Process -FilePath "cmd.exe" -ArgumentList "/c cd frontend && npm run dev > ..\logs\frontend.log 2>&1" -WindowStyle Hidden
}

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "  🎉 SOVEREIGN AGENT AI WORKBENCH IS UP AND RUNNING!" -ForegroundColor Green
Write-Host "======================================================================" -ForegroundColor Cyan

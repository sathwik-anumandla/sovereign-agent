...
```bash
pip install pydantic sympy pandas openpyxl python-docx python-pptx opencv-python scikit-learn ollama
```
...
### Run Multi-Model Swap Benchmark (Phase 3)
```bash
python3 phase1_inference.py
```
